...
if __name__=="__main__": #syntax of main function
    ...
    while True:
        ...
        if 'time' in query:
            ...
            url='https://api.openweathermap.org/data/2.5/weather?q=mumbai&units=imperial&appid=0cbbc8f4a1da13dd6897594b38257655'
            ...
            print(temp)
            print(desp)
            speak('temperaure :{} degree celcius'.format(temp))
